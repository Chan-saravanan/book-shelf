...
import {getBookWithReviewer, clearBookWithReviewer} from '../../actions/index';
        ...
        books.book ? 
            <div className="br_container">
                <div className="br_header">
                    ...
                    <div className="br_reviwer">
                        <span className="">Reviw by</span> {books.reviewer.name} {books.reviewer.lastname}
                    </div>
                </div>
